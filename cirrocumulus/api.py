...
from .util import filter_dataset_directory, get_fs, get_scheme, json_response, open_file
...
def handle_server():
    ...
    d["server_files"] = []
    if CIRRO_DATA_DIR in os.environ and os.environ[CIRRO_DATA_DIR]:
        d["server_files"] = filter_dataset_directory(os.environ[CIRRO_DATA_DIR])
